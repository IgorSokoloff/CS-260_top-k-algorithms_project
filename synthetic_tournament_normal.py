...
parser.add_argument('--mean', action='store', dest='mean', type=float, default=0, help='mean')
parser.add_argument('--sigma', action='store', dest='sigma', type=float, default=1, help='sigma')
